function validateForm() {
                    ...
                    if (!parseFloat(discountPrice) || parseFloat(discountPrice) <= 0) {
                        ...
                        document.getElementById("dcPriceError").innerText = "Discount Price must be less than Actual Price.";
                        isValid = false;
                    }
                    ...
                    if(imageCount<3){
                        document.getElementById("imageError").innerText = "At least three image is required."
                        isValid = false;
                    }
                    ...
                    if(!color){
                        document.getElementById("colorerror").innerText = "Enter a color";
                        isValid = false;
                    }
                    return isValid;
